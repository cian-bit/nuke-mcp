...
class MockNukeServer:
    ...
    def _audit_acescct_consistency(self, p: dict) -> dict:
        ...
        # Mock the addon's "C2 not yet shipped" path -- the wrapper's
        # graceful-degradation branch is exercised on the server side
        # before the call ever reaches the wire.
        return {
            "findings": [],
